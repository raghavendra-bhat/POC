...
public class TripBookingActivitiesImpl implements TripBookingActivities {
  ...
  @Override
  public String captureOrder(String name) {
    System.out.println("**************** ORDER  CAPTURED");
    return "orderCaptured";
  }

  @Override
  public String pushMsgToKafka(String name) {
    System.out.println("**************** PUSH MESSAGE TO KAFKA");
    return "pushMsgToKafka";
  }

  @Override
  public String shipOrder(String name) {
