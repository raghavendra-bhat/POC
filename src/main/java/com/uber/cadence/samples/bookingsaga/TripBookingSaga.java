...
public class TripBookingSaga {
  ...
  public static void main(String[] args) {
    ...
    WorkflowOptions workflowOptions =
        new WorkflowOptions.Builder().setWorkflowId("orderCapture").build();
    ...
    TripBookingWorkflow trip1 =
        workflowClient.newWorkflowStub(TripBookingWorkflow.class, workflowOptions);
